...
{\fontsize{10}{12}\robotocondlight
    \noindent{\robotocond Programming Languages (Proficient:)} Java, Python, JavaScript \quad {\robotocond (Experience:)} C, Assembly (MIPS), BASH / tcsh, SQLite Ruby, OCaml, Swift\par
